/* =============================================================
   HIGHWAY Delivery — app logic
   Organized in small, single-purpose functions for easy extension.
   ============================================================= */
...
/* ---------------- Splash ---------------- */
/* A single-color (monochrome) icon set for the splash animation — kept
   unified in one tone (var(--cream)) rather than mixed colorful emoji,
   for a calmer, more exclusive motion feel. */
const SPLASH_ICONS = [
  ICONS.pin,
  ICONS.coffee,
  ICONS.cake,
...
/* Show today's date prefix in confirm form */
...
document.getElementById('confirmForm').addEventListener('submit', function(e){
  ...
  setTimeout(()=>{
    const fullOrderNumber = `ORD#${getDatePrefix()}-${orderSuffix}-${randomSeq()}`;
...
/* Init header state for the default screen */
